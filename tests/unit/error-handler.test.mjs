...
describe('errorHandler', () => {
  ...
  it('logs error with method and path', () => {
    ...
    const req = { method: 'POST', path: '/screenshot', headers: {} };
    const res = createMockRes();
  ...
  it('does not call next', () => {
    ...
    handler(new Error('test'), { method: 'GET', path: '/', headers: {} }, res, next);
  ...
  it('handles errors without stack trace', () => {
    ...
    const req = { method: 'DELETE', path: '/admin/keys/abc', headers: {} };
    const res = createMockRes();
